...
d2s_IP_JTAG::getWriteTemplatePatternName() {
    ...
    switch(jtag_mode){
            case JTAG_WR_IR0:
	            temp_test = "d2s_JTAG_writeIR0_template_STD_h16";
	            break;							
            case JTAG_WR_DR0:
	            temp_test = "d2s_JTAG_writeDR0_template_STD_h16";
	            break;				
            case JTAG_WR_IR1:
	            temp_test = "d2s_JTAG_writeIR1_template_STD_h16";
	            break;				
            case JTAG_WR_DR1:
	            temp_test = "d2s_JTAG_writeDR1_template_STD_h16";
	            break;				
            case JTAG_WR_IR2:
	            temp_test = "d2s_JTAG_writeIR2_template_STD_h16";
	            break;				
            case JTAG_WR_DR2:
                    //d2s_template_id=jtag_mode;
                    //break;
	            temp_test = "d2s_JTAG_writeDR2_template_STD_h16";
	            break;						
            default:
